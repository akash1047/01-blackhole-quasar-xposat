...
Short definitions for the [black hole](black-holes.md) and [quasar](quasars.md) pages.
...
| **Eddington luminosity** | Radiation-pressure limit: $L_\mathrm{Edd} \approx 1.3\times10^{38}\,(M/M_\odot)\,\mathrm{erg\,s^{-1}}$. Quasars often run at a sizable fraction of this. |
| **Event horizon** | Surface of no return. Radius $R_\mathrm{s}=2GM/c^2$ if the hole does not spin. |
| **Gravitational radius** | $r_g = GM/c^2 = R_\mathrm{s}/2$. Convenient inner-engine unit. |
| **ISCO** | Innermost stable circular orbit. $3\,R_\mathrm{s}$ if non-spinning; closer if spinning. |
...
| **Photon sphere** | Unstable light orbit at $1.5\,R_\mathrm{s}$ (non-spinning). |
...
| **SMBH** | Supermassive black hole, $\gtrsim 10^6\,M_\odot$, at a galaxy center. |
